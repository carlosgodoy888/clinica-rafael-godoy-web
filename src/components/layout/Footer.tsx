    ...
    <footer className="bg-gray-900 text-gray-300" aria-label="Pie de página">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-gray-400 mb-3">
              Especialista en Estomatología con más de 35 años de experiencia en
              Córdoba. Formación en la Universidad de Montpellier. Tecnología
              avanzada y trato cercano.
            </p>
          ...
          {/* Columna 4: Tratamientos principales */}
          <div>
            <h4 className="text-white font-semibold mb-5 text-sm uppercase tracking-wide">
              Tratamientos
            </h4>
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <Link
                  href="/tratamientos"
                  className="block hover:text-teal-400 transition-colors py-2 min-h-[44px] flex items-center font-semibold text-gray-200"
                >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-xs text-gray-500 flex flex-col sm:flex-row justify-between gap-2">
          <p>
            © {currentYear} Clínica Dental Dr. Rafael Godoy, Córdoba. Todos los
            derechos reservados.
          </p>
